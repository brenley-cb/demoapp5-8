"""
Django settings for demoapp5_8 project.
...
WSGI_APPLICATION = 'demoapp5_8.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "demoapp5_8 API",
    "DESCRIPTION": "API documentation for demoapp5_8 App",
    "VERSION": "v1",
}
